...
class TestCrossFindingContradictionContract:
    ...
    def test_contract_wording_is_domain_neutral(self):
        ...
        Scoped to the NEW contradiction-check step (item 3) and its Reword
        clause (item 4's added sentence) only -- the file's pre-existing
        ...
        start = full_text.index("3. **Check the full batch for contradictions**")
